...
const CalendarIcon = ({ width = 20, height = 20, fill = "#374151" }) => {
  return (
    <svg
      width={width}
      height={height}
    ...
    >
      <path
        ...
        stroke={fill}
      />
      <path d="M5.8335 3.33301V2.08301" stroke={fill} strokeLinecap="round" />
      <path d="M14.1665 3.33301V2.08301" stroke={fill} strokeLinecap="round" />
      <path d="M2.0835 7.5H17.9168" stroke={fill} strokeLinecap="round" />
    </svg>
  );
};
