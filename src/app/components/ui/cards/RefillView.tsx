...
export default function RefillView({
  ...
  return (
    <div
      onClick={onRowClick}
      key={order.id}
      className="grid cursor-pointer grid-cols-[1fr_1fr_1fr_1fr_400px] gap-4 items-center rounded-xl bg-white p-1 md:p-2 shadow-[0px_1px_3px_rgba(0,0,0,0.1),_0px_1px_2px_rgba(0,0,0,0.06)]"
    >
