      ...
      <label className="block ">
        ...
        <div className="relative flex items-center">
          ...
          <input
            ...
            className={`w-full focus:ring h-11 p-2 md:px-3 md:py-2.5 border bg-white! rounded-lg outline-none text-gray-900 placeholder:text-gray-500 placeholder:font-normal
            ${
              error
