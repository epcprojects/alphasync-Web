  ...
  return (
    <div className="flex items-center gap-4">
        ...
        {items.slice(0, 5).map((item) => {
          ...
          return (
            <li key={item.href}>
              <Link
                href={item.href}
                className={`nav-link group  flex items-center gap-1 xl:gap-1.5 font-normal rtl:leading-10 whitespace-nowrap text-lg  py-[5px] lg:p-2 lg:pe-5 duration-300 hover:bg-primary/80 ${
                  isActive && "bg-primary"
      ...
      <div className="z-[100] flex ">
        <Menu>
          {/* <MenuButton
            className={`nav-link group outline-none flex items-center gap-1 xl:gap-1.5 font-normal rtl:leading-10 whitespace-nowrap text-lg  py-[5px] lg:p-2 lg:pe-5 duration-300 hover:bg-primary/80 
rounded-full text-white`}
          > */}
          <MenuButton
  ...
  `}
          >
            {/* <span
              className={`rounded-full w-8 h-8 flex items-center justify-center text-white bg-white/20 backdrop-blur`}
            >
              <span
                className={`transition-colors duration-300text-white/50 group-hover:!text-white"
              }`}
              >
                <MoreIcon />
              </span>
