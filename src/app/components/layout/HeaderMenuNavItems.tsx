      ...
      {items.map((item) => {
        ...
        return (
          <li key={item.href}>
            <Link
              href={item.href}
              className={`nav-link group  flex items-center gap-1 xl:gap-1.5 font-normal rtl:leading-10 whitespace-nowrap text-base  py-[5px] lg:p-2 lg:pe-5 duration-300 hover:bg-primary/80 ${
                isActive && "bg-primary"
