  ...
  return (
    <>
      <header
        ...
        } w-full border-b border-white/20 pb-2 md:pb-3.5 z-[99]`}
      >
        <nav className="px-2 md:px-4 flex items-center justify-between  mx-auto ">
          ...
          <div className="items-center hidden gap-4 md:flex">
            <button className="h-8 w-8 md:w-11 md:h-11 rounded-full bg-black/40 backdrop-blur-sm flex items-center justify-center">
