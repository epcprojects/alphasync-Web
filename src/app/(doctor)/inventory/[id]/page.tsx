            ...
            <div>
              ...
              <div className="relative flex flex-col items-start w-fit">
                ...
                <input
                  ...
                  } [&::-webkit-outer-spin-button]:appearance-none [moz-appearance:textfield] [&::-webkit-inner-spin-button]:appearance-none  outline-none bg-white text-gray-900 text-sm rounded-lg block w-full ps-8 pe-16 p-1.5 max-w-44`}
                  placeholder=""
                />
                <button
